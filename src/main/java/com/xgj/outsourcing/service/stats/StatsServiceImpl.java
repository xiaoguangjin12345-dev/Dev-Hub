...
import com.xgj.outsourcing.pojo.vo.stats.StatsResultVO;
...
import com.xgj.outsourcing.service.common.BasicCommonService;
...
public class StatsServiceImpl implements StatsService {
    ...
    public String requestProjectProgress(List<Integer> projectIds){
        ...
        redisService.hashSetAll(redisKey, new StatsResultVO<ProjectProgressVO>(ProcessStatus.Pending.getValue()));
    ...
    public String requestHoursAnalysis(byte dimensionNum){
        ...
        // 设置Redis记录状态
        redisService.delete(redisKey);    // 先删除原始记录
        redisService.hashSetAll(redisKey, new StatsResultVO<HoursAnalysisVO>(ProcessStatus.Pending.getValue()));
    ...
    public String requestDevCapability(int targetDevId){
        ...
        // 设置Redis记录状态
        redisService.delete(redisKey);    // 先删除原始记录
        redisService.hashSetAll(redisKey, new StatsResultVO<DevCapabilityVO>(ProcessStatus.Pending.getValue()));
    ...
    public String requestDevEfficiency(){
        ...
        // 设置Redis记录状态
        redisService.delete(redisKey);    // 先删除原始记录
        redisService.hashSetAll(redisKey, new StatsResultVO<DevEfficiencyVO>(ProcessStatus.Pending.getValue()));
