...
import com.xgj.outsourcing.service.hourlog.HourLogService;
...
public class HourLogController {
    ...
    public APIResponse<Boolean> checkCreateActualLog(@RequestParam String UUIDStr){
        Boolean result = hourLogService.checkRecordActualHourLog(UUIDStr);
